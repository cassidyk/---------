...
rm -rf ${script_path}/root-image/root/archlive
rm -rf ${work_dir}
rm -rf ${out_dir}

# copy archlive folder to image
cp -R /root/archlive /root/archlive-clone
mv /root/archlive-clone ${script_path}/root-image/root/archlive
